...
def MILP_calculate_startup_output(m):
    # e_pro_out = e_pro_out_no_start(t) * run[1/0](t) * (1-  startup[1/0](t) * (1 - (tm - t_startup)/tm ))
    ...
    # Rule 4: e_pro_out(t) - e_help(t) >= -(1 - run[1/0](t)) * e_out_max
    #       e_help(t) = e_pro_out_no_start(t) * (1 - startup[1/0](t))      linearized:
    #       Rule 4.1: e_help(t) - e_pro_out_no_start(t) <= startup[1/0](t) * e_out_max
    #       Rule 4.2: e_help(t) - e_pro_out_no_start(t) >= - startup[1/0](t) * e_out_max
    #       Rule 4.3: e_help(t) <= (1 - startup[1/0](t)) * e_out_max
    #       Rule 4.4: e_help(t) >= -(1 - startup[1/0](t)) * e_out_max
...
def res_partial_process_output_MILP_rule_4_1(m, tm, stf, sit, pro, coo):
    # Rule 4.1: e_help(t) - e_pro_out_no_start(t) <= startup[1/0](t) * e_out_max
    return m.pro_out_help_var[tm, stf, sit, pro, coo] - m.e_pro_out_no_start_up[tm, stf, sit, pro, coo] \
           <= m.pro_mode_startup[tm, stf, sit, pro] * m.process_dict['cap-up'][(stf, sit, pro)] * m.dt
